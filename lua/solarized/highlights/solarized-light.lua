...
M.set_highlight = function(colors, config)
  ...
  if config.plugins['nvim-treesitter'] then
    ...
    nvim_set_hl('@markup.strong', { fg = colors.magenta })
    nvim_set_hl('@markup.italic', { link = 'Underlined' })
    nvim_set_hl('@markup.strikethrough', { fg = colors.base1 })
    nvim_set_hl('@markup.underline', { link = 'Underlined' })
    nvim_set_hl('@markup.heading', { fg = colors.blue })
    nvim_set_hl('@markup.quote', { fg = colors.base1 })
    nvim_set_hl('@markup.math', { fg = colors.magenta })
    ...
    nvim_set_hl('@markup.raw', { link = 'Constant' })
    nvim_set_hl('@markup.raw.block', { fg = colors.base0 })
    nvim_set_hl('@markup.list', { fg = colors.base0 })
    nvim_set_hl('@markup.list.checked', { fg = colors.git_add })
    nvim_set_hl('@markup.list.unchecked', { fg = colors.git_modify })
