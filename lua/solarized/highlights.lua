local highlights = {
		...
		SpellLocal = {fg = C.blue, style = "underline", },
		...
		MatchParen = {fg = C.hint_green, bg = C.bg, style = "underline", },
		...
		Search = {fg = C.light_gray, bg = C.search_green, },
		IncSearch = {fg = C.light_gray, bg = C.search_green, },
