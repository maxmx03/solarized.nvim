...
solarized.highlights = {
  ...
  DiagnosticUnderlineHint = { fg = 'NONE', bg = 'NONE', sp = colors.hint, undercurl = true },
  DiagnosticUnderlineInfo = { fg = 'NONE', bg = 'NONE', sp = colors.info, undercurl = true },
  DiagnosticUnderlineWarn = { fg = 'NONE', bg = 'NONE', sp = colors.warning, undercurl = true },
  DiagnosticUnderlineError = { fg = 'NONE', bg = 'NONE', sp = colors.danger, undercurl = true },
  ...
  LspReferenceRead = { fg = 'NONE', bg = colors.bg_alt_invert },
  LspReferenceText = { fg = 'NONE', bg = colors.bg_alt_invert },
  LspReferenceWrite = { fg = 'NONE', bg = colors.bg_alt_invert },
  LspCodeLens = { fg = colors.commet, bg = 'NONE', italic = true },
  LspCodeLensSeparator = { fg = colors.commet, bg = 'NONE', italic = true },
