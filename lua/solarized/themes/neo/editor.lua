return function(c, config)
  ...
  set_hl('NormalFloat', { fg = c.base0, bg = c.base04 }, { transparent = not config.transparent }) -- Normal text in floating windows
  ...
  set_hl('PmenuSbar', { bg = c.base04 }) -- Popup menu: Scrollbar
  ...
  set_hl('StatusLine', { fg = c.base1, bg = c.base04 }) -- Status line of current window.
  set_hl('StatusLineNC', { fg = c.base00, bg = c.base04 }) -- Status lines of not-current windows.
  set_hl('TabLine', { bg = c.base04 }) -- Tab pages line, not active tab page label.
  set_hl('TabLineFill', { fg = c.base0, bg = c.base04 }) -- Tab pages line, where there are no labels.
