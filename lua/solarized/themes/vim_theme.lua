local function vim_theme(solar)
  ...
  return {
    ...
    NvimTreeIndentMarker = { fg = colors.fg, bg = 'NONE' },
    ...
    NvimTreeFolderName = { fg = colors.blue, bg = 'NONE' },
    NvimTreeOpenedFolderName = { fg = colors.blue, bg = 'NONE', bold = true, italic = true },
    NvimTreeEmptyFolderName = { link = 'Comment' },
    NvimTreeOpenedFile = { fg = 'NONE', bg = colors.bg_alt },
    NvimTreeGitIgnored = { link = 'Comment' },
    NvimTreeImageFile = { fg = colors.fg, bg = 'NONE' },
    NvimTreeSpecialFile = { fg = colors.violet, bg = 'NONE', underline = true },
    NvimTreeEndOfBuffer = { fg = colors.bg, bg = 'NONE' },
    NvimTreeCursorLine = { link = 'CursorLine' },
    NvimTreeGitStaged = { fg = colors.added, bg = 'NONE' },
    NvimTreeGitNew = { fg = colors.added, bg = 'NONE' },
    NvimTreeGitRenamed = { fg = colors.added, bg = 'NONE' },
    NvimTreeGitDeleted = { fg = colors.deleted, bg = 'NONE' },
    NvimTreeGitMerge = { fg = colors.changed, bg = 'NONE' },
    NvimTreeGitDirty = { fg = colors.changed, bg = 'NONE' },
    NvimTreeSymlink = { fg = colors.cyan, bg = 'NONE' },
    NvimTreeRootFolder = { fg = colors.blue, bg = 'NONE', bold = true },
