return function(c, config)
  ...
  -- NOTE: Misture o tema do original com o do vscode, tente deixar o mais bonito possivel
  -- e que as cores façam sentido.
  ...
  set_hl('@define', { link = 'PreProc' }) -- preprocessor definition directives
  ...
  set_hl('@keyword.coroutine', { link = 'Operator' }) -- keywords related to coroutines (e.g. `go` in Go, `async/await` in Python)
  ...
  set_hl('@keyword.return', { link = 'Operator' }) -- keywords like `return` and `yield`
  ...
  set_hl('@debug', { link = 'Special' }) -- keywords related to debugging
  ...
  set_hl('@storageclass', { link = 'Type' }) -- modifiers that affect storage in memory or life-time
  ...
  set_hl('@namespace', { link = 'Constant' }) -- modules or namespaces
