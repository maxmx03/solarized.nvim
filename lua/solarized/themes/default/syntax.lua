return function(c, config)
  ...
  set_hl('String', { link = 'Constant' }) -- a string constant: "this is a string"
  set_hl('Character', { link = 'Constant' }) -- a character constant: 'c', '\n'
  ...
  set_hl('Float', { link = 'Constant' }) -- a floating point constant: 2.3e10
  set_hl('Identifier', { fg = c.blue }, { styles = config.styles.variables }) -- any variable name
  set_hl('Function', { link = 'Identifier' }, { styles = config.styles.functions }) -- function name (also: methods for classes)
  ...
  set_hl('Operator', { fg = c.green }) -- "sizeof", "+", "*", etc.
  ...
  set_hl('StorageClass', { link = 'Type' }) -- static, register, volatile, etc.
  set_hl('Structure', { link = 'Type' }) -- struct, union, enum, etc.
  set_hl('Typedef', { link = 'Type' }) -- A typedef
