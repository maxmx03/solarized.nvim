describe('Palette', function()
  ...
  it('should extends solarized color palette', function()
    ...
    local output = solarized_palette.extend_colors(default_colors, custom_colors)
  ...
  it('should fix any invalid color when extending solarized color palette', function()
    local default_colors = solarized_palette.get_colors()
    local custom_colors = {
      white = '#aaaaaaa',
      pink = '#cf9',
